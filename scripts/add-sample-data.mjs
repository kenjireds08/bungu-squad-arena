...
const SAMPLE_DATA = {
  Players: [
    ...
    ['player_002', 'ワラビサコ', 'warabisako@example.com', 1850, 25, 15, 68, 32, '★,★,☆,♠️,➕', true, '2023-08-10', true, '2023-11-20', '2023-05-20 14:20:00', '', true, '2024-07-25 19:30:00', 'active', '{"match_start": true, "result_pending": false}', '[]', '2024-07-25 19:00:00', true, 'ja', '', '', ''],
